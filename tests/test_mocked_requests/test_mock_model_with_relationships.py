...
def test_load_model_from_json(monkeypatch, mock_post):
    """
...
def test_load_model_with_database_connection(monkeypatch, mock_post):
...
def test_load_model_with_many(monkeypatch, mock_post):
    """Tests a relationship using a database connection.
