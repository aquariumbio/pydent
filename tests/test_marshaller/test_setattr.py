...
def test_setattr():
    """This test ensures that relationship attributes automatically update.
    Attributes retrieved from fullfilling relationships should *not* be saved.
    """
    @add_schema
    ...
    # when underlying parameters used in callback change, myrelation should
    # change as well
    m.myrelation = None
    m.other_id = 6
