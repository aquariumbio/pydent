...
docs:
	...
	pipenv run pandoc --from=markdown --to=rst --output=docsrc/developer/contributing.rst contributing.md
	pipenv run pandoc --from=markdown --to=rst --output=docsrc/user/installation.rst installation.md
