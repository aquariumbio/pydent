...
def generate_fake_op_data(session):
    ...
    op_data['operation_type']['field_types'] = op.operation_type.field_types.dump(relations=('allowable_field_types',))
...
def fake_op():
    ...
    fake_op_data = {'created_at': '2017-11-30T16:25:49-08:00',
                    'field_values': [{'allowable_field_type_id': 4094,
                                     ...
                                     {'allowable_field_type_id': 4097,
                                      ...
                                      'created_at': '2017-11-30T16:25:49-08:00',
                                      'field_type': {
                                          'allowable_field_types': [{'created_at': '2017-11-30T13:33:25-08:00',
                                                                     'field_type_id': 9073,
                                                                     'id': 4097,
                                                                     'object_type_id': 485,
                                                                     'sample_type_id': 15,
